...
let userFeeds = new Instafeed({
  get: "user",
  target: "instafeed-section",
  resolution: "thumbnail",
  limit: 4,
  template:
    '<div class="col-sm-3 px-0"><a href="{{link}}"><img title="{{caption}}" src="{{image}}" class="img-fluid" /></a></div>',
  accessToken:
    "IGQVJYeW1RTlRYbzNjUEU1UFdORUxWbG4xX0ZATbkIxYzdsUWRHU2dpOWI1RUI2QlNOanhjX3NHbEMyX1ZAYV0hEV3FkZA3VHLWlKWllFclB5YkEtTUdDX0dWdkdHbTdLSzJkRUpha0FYZAkxEUGpqajhxSQZDZD",
